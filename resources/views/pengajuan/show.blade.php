                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_advanced_validation"
                                action="{{ route('pengajuan.update', $data_pengajuan->id) }}" enctype="multipart/form-data"
                                method="POST">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div>
                                                    <input type="number" name="price" readonly class="form-control ip"
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <a href="{{ asset('foto_penghuni/' . $data_pengajuan->foto) }}"
                                                    target="_blank" data-sub-html="Demo Description">
                                                    <img src="{{ asset('foto_penghuni/' . $data_pengajuan->foto) }}"
