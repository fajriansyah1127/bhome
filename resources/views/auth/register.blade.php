...
<body class="signup-page">
            ...
            <div class="body">
                <form id="sign_up" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="text" class="form-control" name="name" placeholder="Name Username" required autofocus>
                        </div>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">
    ...
    <script src="{{ asset('template') }}/js/pages/examples/sign-up.js"></script>
</body>
